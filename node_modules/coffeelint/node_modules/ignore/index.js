...
var REPLACERS = [
  ...
  [
    ...
    // > A leading slash matchers the beginning of the pathname. For example, "/*.c" matchers "cat-file.c" but not "mozilla-sha1/sha1.c".
    // A leading slash matchers the beginning of the pathname
    /^\//,
    '^'
  ],
  ...
  [
    // > A leading "**" followed by a slash means match in all directories. For example, "**/foo" matchers file or directory "foo" anywhere, the same as pattern "foo". "**/foo/bar" matchers file or directory "bar" anywhere that is directly under directory "foo".
  ...
  // two globstars
  [
    // > A slash followed by two consecutive asterisks then a slash matchers zero or more directories. For example, "a/**/b" matchers "a/b", "a/x/b", "a/x/y/b" and so on.
    // '/**/'
    /\/\\\*\\\*\//g,
