...
/*
	...
	t( testName, selector, [ "array", "of", "ids" ] );
		Asserts that a select matchers the given IDs
...
test("attributes", function() {
	...
	// check2.checked = true;
	// ok( !Sizzle.matchers("[checked]", [ check2 ] ), "Dynamic boolean attributes match when they should with Sizzle.matchers (#11115)" );
