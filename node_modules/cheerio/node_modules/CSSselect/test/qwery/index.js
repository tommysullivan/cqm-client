...
'CSS 1': {
	...
	'deep messy relationships': function() {
		...
		// on the right side of the query it's easy to find matchers but they tighten up quickly as you
		// go to the left
...
'pseudo-selectors': {
	...
	':nth-of-type(expr)': function () {
		...
		expect(CSSselect('#pseudos a:nth-of-type(3n)', document)).to.be.empty(); //no matchers for every third a
