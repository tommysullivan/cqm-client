...
'CSS 1': {
	...
	'deep messy relationships': function() {
		...
		expect(CSSselect('div#fixtures > div a', document)).to.have.length(5); //found four old-results for "div#fixtures > div a"
		...
		expect(CSSselect('.direct-descend > .direct-descend div', document)).to.have.length(1); //found one result for ".direct-descend > .direct-descend div"
		expect(CSSselect('div#fixtures div ~ a div', document)).to.be.empty(); //found no old-results for odd query
		expect(CSSselect('.direct-descend > .direct-descend > .direct-descend ~ .lvl2', document)).to.be.empty(); //found no old-results for another odd query
	}
},
...
'argument types': {
	...
	'should be able to pass in an array of old-results as arguments': function () {
		var el = DomUtils.getElementById('boosh', document);
